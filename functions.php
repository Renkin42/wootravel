<?php
/**
 * Woo Traveller functions and definitions.
 *
...
if ( ! function_exists( 'wootravel_setup' ) ) :
/**
...
function wootravel_setup() {
	 ...
	 * If you're building a theme based on Woo Traveller, use a find and replace
	 * to change 'wootravel' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'wootravel', get_template_directory() . '/languages' );
	...
	add_image_size( 'carousel-thumb', 200, 180, true );

	// This theme uses wp_nav_menu() in one location.
	register_nav_menus( array(
		'primary' => esc_html__( 'Primary', 'wootravel' ),
	) );
	...
	add_theme_support( 'custom-background', apply_filters( 'wootravel_custom_background_args', array(
 ...
 */
function wootravel_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wootravel_content_width', 640 );
}
add_action( 'after_setup_theme', 'wootravel_content_width', 0 );
...
add_action( 'wp_enqueue_scripts', 'wootravel_scripts' );
